...
const LandingPage: NextPage = () => (
  <>
    <Head>
      <title>Unicodes: Your Coding Companion</title>
      <meta property="og:title" content="Unicodes: Your Coding Companion" />
      <meta property="og:description" content="Reading and writing code is hard! Unicodes helps you interpret the details so you can focus on building what matters" />
    ...
    <div className="relative bg-hero overflow-hidden">
              ...
              <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                <div>
                  ...
                  <p className="mt-3 text-base text-gray-300 sm:pr-4 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    Reading and writing code is hard! Unicodes helps you interpret the details
      ...
      <div className="relative bg-white py-16 overflow-hidden">
        <div className="mt-8 mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
          <div>
            <h2 className="text-base font-semibold tracking-wider text-primary uppercase">Unicodes is</h2>
          ...
          <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
            ...
            Unlock the Multilingual Power of Code with Unicodes: Your AI-Driven Shortcut to Seamless Programming Across Languages.
          </p>
        </div>
      </div>
          ...
          <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-3 lg:grid-flow-col-dense lg:gap-24">
              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-500">
                    Struggling to grasp the code you're working on?
                    {' '}
                    <span className="py-px px-1 bg-gray-100 rounded-md text-primary font-medium">Let Explain Code</span>
                    {' '}
                    break it down for you in plain English, making it easy to understand
                  </p>
                  <div className="mt-6">
                    <Link href="/api/auth/login" passHref>
                      <button
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div className="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                  ...
                  <img   className='w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none' src="videos/explain.PNG"  />
            ...
            <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-gray-500">
                    Don&apos;t like writing documentation for your functions? Have Unicodes&apos;s
                    {' '}
