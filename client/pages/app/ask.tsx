...
export default function Ask() {
  ...
  useEffect(() => {
    ...
    // Since you're using router.replace with the same pathname, it looks like you're just refreshing the page
    router.replace(router.pathname);
  
  }, [input, inputLanguage, outputLanguage, output]); // Include query parameters in the dependency array
